class App {
    ...
    static SweetAlert = class {
        ...
        static showSuspendedConfirmDialog() {
            return Swal.fire({
                icon: 'warning',
                text: 'Bạn chắc chắn muốn xóa nó ?',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
                confirmButtonText: 'Vâng, chắc chắn là như vậy ròi !',
    ...
    static renderRowCustomer(obj) {
        ...
        <tr id="tr_${obj.id}">
            ...
            <td class="text-end num-space">
                ${new Intl.NumberFormat('vi-VN', {style: 'currency', currency: 'VND'}).format(obj.balance)}
            </td>
                <td class="text-center">
                    <a class="btn btn-outline-secondary edit" data-id="${obj.id}" title="" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Edit">
                ...
                <td class="text-center">
                    <a class="btn btn-outline-warning withdraw" data-id="${obj.id}" title="" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Withdraw">
                        <i class="fas fa-minus"></i>
                    </a>
                </td>
                <td class="text-center">
                    <a class="btn btn-outline-primary transfer" data-id="${obj.id}" title="" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Transfer">
                        <i class="fas fa-exchange-alt"></i>
                    </a>
                </td>
                <td class="text-center">
                    <a class="btn btn-outline-danger delete" data-id="${obj.id}" title="" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="suspended">
